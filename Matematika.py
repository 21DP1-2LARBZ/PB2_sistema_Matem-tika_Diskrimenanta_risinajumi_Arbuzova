...
def atzime(rezultats, maksimali, darbs):
    ...
    if vertejums <= 0.1:  # nosaka kāds ir vērtējums
        ...
        print('Vērtējums: 2(ļoti slikti)')
    elif vertejums <= 0.3:
        print('Vērtējums: 3(slikti)')
    elif vertejums <= 0.4:
...
def teorija():
    teorija_fails = open('teorija.txt', 'r', encoding='utf8')
    print(teorija_fails.read())
    teorija_fails.close()
